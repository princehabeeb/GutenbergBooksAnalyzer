...
const RevenueChart = () => {
  ...
  return (
    <div className="p-3 sm:p-4 md:px-6 lg:px-10 md:py-6 lg:py-8 rounded-2xl border dark:border-n500 bg-n0 dark:bg-bg4">
      <p className="mb-6 pb-6 bb-dashed font-medium">Monthly Revenue</p>
      <div className="grid grid-cols-12 gap-4 lg:gap-6">
        <div className="col-span-12 max-h-[330px] overflow-hidden">
          <ApexChart
            options={candlestick}
            series={candlestick.series}
            type="candlestick"
            height={windowSize! > 580 ? 320 : 200}
            width={"100%"}
          />
        </div>
      </div>
