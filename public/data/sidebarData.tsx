...
export const sidebarData = [
  {
    ...
    items: [
      ...
      },
      {
        id: 2,
        name: "Finance",
        icon: <IconCoins className="w-5 h-5 lg:w-6 lg:h-6" />,
        submenus: [
      ...
      },
      {
        id: 3,
        name: "Banking",
        icon: <IconBuildingBank className="w-5 h-5 lg:w-6 lg:h-6" />,
        submenus: [
      ...
      },
      {
        id: 4,
        name: "Business",
        icon: <IconBriefcase className="w-5 h-5 lg:w-6 lg:h-6" />,
        submenus: [
      ...
      },
      {
        id: 6,
        name: "Apps",
        icon: <IconDeviceMobilePlus className="w-5 h-5 lg:w-6 lg:h-6" />,
        submenus: [
      ...
      },
      {
        id: 8,
        name: "Widgets",
        icon: <IconApps className="w-5 h-5 lg:w-6 lg:h-6" />,
        submenus: [
